...
// if(isset($_POST['passwordRecoveryBtn'], $_POST['token'])){
//
//   if (validate_token($_POST['token'])) {
//     $form_errors = array();
//
...
//                 $email = $rs['email'];
//                 $user_id = $rs['id'];
//                 $encode_id = base64_decode("encodeuserid{$user_id}");
//
...
//                 ]); */
//
//                 //prepare email body   Token: '.$reset_token.' <br />
...
//
//                     </p>
//                     <p><a href="http://localhost/c_login/forgot_password.php?id='.$encode_id.'"> Reset Password</a></p>
//                     <p><strong>&copy;'.date('Y').' Login System</strong></p>
//                     </body>
//                     </html>';
//
//                 $mail->addAddress($email, $username);
//                 $mail->Subject = "Password Recovery Message from andre";
//                 $mail->Body = $mail_body;
//
