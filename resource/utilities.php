...
* checked if the cookie used is same with the encrypt cookie
...
function isCookieValid($db){
 ...
 if (isset($_COOKIE['rememberUserCookie'])) {
   ...
   */
   ...
   $user_id = explode("UaQteh5i43dntstemYODEC", $decryptCookieData);
   $userID = $user_id[1];
   ...
   */
   ...
   if ($row = $statement->fetch()){
     ...
     */
     ...
     /*
        cookie ID is ivalid destroy session and logout userID
       */
       $isValid = false;
       $this->signout();
   }
